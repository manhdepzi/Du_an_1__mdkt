<div class="span3">
	<div class="sidebar">
		...
		<ul class="widget widget-menu unstyled">
			<li><a href="category.php"><i class="menu-icon icon-table"></i>Quản lý danh mục </a></li>
			<li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Danh mục sản phẩm </a></li>
