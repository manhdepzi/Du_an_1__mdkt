...
<?php echo htmlentities($row['productDescription']); ?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="./admin/views/productimages/30/<?php echo htmlentities($row['productImage1']); ?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id']; ?>">Change Image</a>
												</div>
											</div>
