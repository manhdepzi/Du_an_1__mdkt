        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= ROOT_URL ?>">Trang chủ</a>
                    </li>
                ...
                <div class="auth-buttons ms-3">
                    <?php if (isset($_SESSION['user'])): ?>
                        <a href="<?= ROOT_URL ?>?ctl=profile"><i class="bi bi-person-circle"></i> Hồ sơ</a>
                        <a href="<?= ROOT_URL ?>?ctl=logout" onclick="confirmLogout(event)"><i
                                class="bi bi-box-arrow-right"></i> Đăng xuất</a>
                    <?php else: ?>
                        <a href="views/users/login.php"><i class="bi bi-person-circle"></i> Đăng nhập</a>
                        <a href="views/users/register.php"><i class="bi bi-pencil-square"></i> Đăng ký</a>
                    <?php endif ?>
                </div>
    ...
    <script>
        function confirmLogout(event) {
            ...
            if (confirm("Bạn có chắc chắn muốn đăng xuất?")) {
                window.location.href = "<?= ROOT_URL ?>?ctl=logout"; // Chuyển hướng đến hành động logout
            }
        }
    </script>
</body>
